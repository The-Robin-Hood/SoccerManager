...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-[14px] font-medium focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-white hover:bg-secondary active:bg-secondary disabled:bg-background",
        outline:
          "text-primary-foreground border border-outline bg-background hover:text-white",
